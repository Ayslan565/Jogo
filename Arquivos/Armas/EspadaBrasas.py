...
class EspadaBrasas(Weapon):
    ...
    def __init__(self):
        ...
        self._stats_by_level = {
            1.0: {
                "damage": 28.0,      # Dano elemental de fogo
                "range": 75.0,       # Alcance similar a outras espadas
                "cooldown": 0.75,    # Velocidade de ataque
                "name_suffix": "",
                "hitbox_dim": (125, 85), # Hitbox em forma de arco
                "hitbox_off": (70, 0),   # Posição da hitbox
        ...
        super().__init__(
            ...
            damage=initial_stats_for_super.get("damage", 28.0),
            attack_range=initial_stats_for_super.get("range", 75.0),
            cooldown=initial_stats_for_super.get("cooldown", 0.75),
            hitbox_dimensions=initial_stats_for_super.get("hitbox_dim", (125, 85)),
            hitbox_offset=initial_stats_for_super.get("hitbox_off", (70, 0)),
            description="Uma lâmina forjada no fogo eterno, que queima ao toque.",
            rarity="Rara",
            weapon_type="Espada",
            element="Fogo", # Elemento da arma
        ...
        for path_relativo in caminhos:
            ...
            try:
                if os.path.exists(full_path):
                    ...
                    placeholder = pygame.Surface((50, 50), pygame.SRCALPHA); placeholder.fill((255,100,0,100))
