...
class EspadaBrasas(Weapon):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            ui_icon_path=initial_stats_for_super.get("ui_icon", "Sprites/Armas/Espadas/EspadaBrasas/Icone_E1.png") # Exemplo
        )
        ...
        self._stats_by_level = {
            ...
            1.0: {
                ...
                "effect_sprite_base": "Sprites/Armas/Espadas/EspadaBrasas/Efeitos/ImpactoNv1.png", # Exemplo
                ...
                "animation_sprites": [     # CONFIGURÁVEL: Caminhos para os sprites da animação de ataque
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv1/Frame1.png",
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv1/Frame2.png",
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv1/Frame3.png"
                ],
                ...
                "ui_icon": "Sprites/Armas/Espadas/EspadaBrasas/Icone_E1.png" # Exemplo
            },
            1.5: {
                "damage": 35.0, "range": 70.0, "cooldown": 1.4, "name_suffix": "+1",
                "hitbox_dim": (75, 105), "hitbox_off": (0, 0), # Exemplo
                "effect_sprite_base": "Sprites/Armas/Espadas/EspadaBrasas/Efeitos/ImpactoNv1.png", # Pode ser o mesmo ou mudar
                "effect_scale_base": 1.05,
                "animation_sprites": [ # Pode reusar ou ter animação levemente diferente
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv1/Frame1.png", # Reutilizando
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv1/Frame2.png",
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv1/Frame3.png"
                ],
                "animation_speed": 95,
                "animation_display_scale": 1.0, # Mesma escala de animação
                "ui_icon": "Sprites/Armas/Espadas/EspadaBrasas/Icone_E1.png" # Exemplo, pode ser o mesmo
            },
            2.0: {
                "damage": 45.0, "range": 75.0, "cooldown": 1.2, "name_suffix": " Desperta",
                "hitbox_dim": (80, 110), "hitbox_off": (0, 0), # Exemplo
                "effect_sprite_base": "Sprites/Armas/Espadas/EspadaBrasas/Efeitos/ImpactoNv2.png", # Exemplo
                "effect_scale_base": 1.1,
                "animation_sprites": [
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv2/Frame1.png",
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv2/Frame2.png",
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv2/Frame3.png",
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv2/Frame4.png"
                ],
                "animation_speed": 90,
                "animation_display_scale": 1.1, # Animação um pouco maior
                "ui_icon": "Sprites/Armas/Espadas/EspadaBrasas/Icone_E2.png" # Exemplo
            },
            2.5: {
            ...
            3.0: {
                ...
                "effect_sprite_base": "Sprites/Armas/Espadas/EspadaBrasas/Efeitos/ImpactoNv3.png", # Exemplo
                "effect_scale_base": 1.2,
                "animation_sprites": [
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv3/Frame1.png",
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv3/Frame2.png",
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv3/Frame3.png",
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv3/Frame4.png",
                    "Sprites/Armas/Espadas/EspadaBrasas/Ataque/Nv3/Frame5.png"
                ],
                "animation_speed": 80,
                "animation_display_scale": 1.2, # Animação maior e mais imponente
                "ui_icon": "Sprites/Armas/Espadas/EspadaBrasas/Icone_E3.png" # Exemplo
            }
        }
    ...
    def _get_stats_for_level_internal(self, level_to_check, for_super_init=False):
        ...
        if for_super_init or not hasattr(self, '_stats_by_level') or not self._stats_by_level:
            ...
            if hasattr(self, '_stats_by_level') and self._stats_by_level and 1.0 in self._stats_by_level:
                ...
                return {
                    ...
                    "effect_sprite_base": "Sprites/Armas/Espadas/EspadaBrasas/Efeitos/ImpactoDefault.png", # Caminho de fallback
                    "effect_scale_base": 1.0,
                    "animation_sprites": [], "animation_speed": 100, "animation_display_scale": 1.0,
                    "ui_icon": "Sprites/Armas/Espadas/EspadaBrasas/Icone_Default.png" # Caminho de fallback
                }
        ...
        if level_to_check in self._stats_by_level:
            ...
            print(f"WARN(EspadaBrasas): Nível {level_to_check} não encontrado em _stats_by_level. Usando fallback para o primeiro nível.")
    ...
    def _load_weapon_attack_animation_sprites(self, caminhos, escala_animacao=1.0):
        ...
        # __file__ é o caminho para EspadaBrasas.py (ex: .../SeuJogo/Armas/EspadaBrasas.py)
            ...
            try:
                if os.path.exists(full_path):
                    ...
                    if novo_w > 0 and novo_h > 0:
                        ...
                        print(f"WARN(EspadaBrasas): Escala da animação resultou em dimensão inválida para '{full_path}'. Usando placeholder.")
                    ...
                    print(f"WARN(EspadaBrasas): Sprite de animação de ATK não encontrado '{full_path}'. Usando placeholder.")
                    ph_size = max(1, int(50 * (escala_animacao if escala_animacao > 0 else 1.0)))
                    placeholder = pygame.Surface((ph_size, ph_size), pygame.SRCALPHA); placeholder.fill((255,0,255,100))
                    sprites_carregados.append(placeholder)
            except pygame.error as e:
                print(f"ERROR(EspadaBrasas): Erro ao carregar sprite de animação de ATK '{full_path}': {e}. Usando placeholder.")
                ph_size = max(1, int(50 * (escala_animacao if escala_animacao > 0 else 1.0)))
                placeholder = pygame.Surface((ph_size, ph_size), pygame.SRCALPHA); placeholder.fill((255,0,255,100))
                sprites_carregados.append(placeholder)
        ...
        # print(f"DEBUG(EspadaBrasas): {len(sprites_carregados)} sprites de animação de ATK carregados para {self.name} com escala {escala_animacao}.")
    ...
    def evolve(self, target_level: float):
        ...
        if target_level in self._stats_by_level:
            ...
            print(f"WARN(EspadaBrasas): Nível de evolução {target_level} inválido para {self.name}. Níveis disponíveis: {list(self._stats_by_level.keys())}")
    ...
    def _apply_level_stats(self):
        ...
        if not stats: # Segurança adicional, embora _get_stats_for_level_internal deva sempre retornar algo
            print(f"ERROR(EspadaBrasas): Falha crítica ao obter stats para o nível {self.level} de '{self.name}'. Nenhuma alteração aplicada.")
            return
        ...
        if new_base_effect_path and new_base_effect_path != self.attack_effect_sprite_path:
            ...
            if self.attack_effect_original_image:
                ...
                if width > 0 and height > 0:
                    ...
                    print(f"WARN(EspadaBrasas): Escala do efeito de ataque resultou em dimensão inválida para '{self.attack_effect_sprite_path}'.")
...
if __name__ == '__main__':
    ...
    # Isto é útil para verificar a lógica da classe EspadaBrasas isoladamente.
