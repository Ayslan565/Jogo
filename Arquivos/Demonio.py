...
try:
    ...
    print("DEBUG(Demonio): Classe base Inimigo importada com sucesso.")
except ImportError:
    print("DEBUG(Demonio): ERRO: Módulo 'Inimigos.py' não encontrado. Usando classe Inimigo placeholder.")
