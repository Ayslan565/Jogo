...
class Morte(InimigoBase):
    ...
    @staticmethod
    def _carregar_som_Morte(caminho_relativo):
        caminho_completo = os.path.join(Morte._obter_pasta_raiz_jogo(), caminho_relativo.replace("/", os.sep))
    ...
    def carregar_recursos_Morte():
        if Morte.sprites_originais is None:
            Morte.sprites_originais = []
            # MODIFICADO: Lista explícita com os caminhos completos relativos à raiz do projeto
            caminhos_sprites = [
                "Sprites\\Inimigos\\Morte\\A (1).png",
                "Sprites\\Inimigos\\Morte\\A (2).png",
                "Sprites\\Inimigos\\Morte\\A (3).png",
                "Sprites\\Inimigos\\Morte\\A (4).png",
                "Sprites\\Inimigos\\Morte\\A (5).png",
            ]
            pasta_raiz = Morte._obter_pasta_raiz_jogo()
            for caminho_relativo in caminhos_sprites:
                ...
                try:
                    if os.path.exists(caminho_completo):
                        ...
                        sprite_scaled = pygame.transform.scale(sprite_img, Morte.tamanho_sprite_definido)
                        Morte.sprites_originais.append(sprite_scaled)
                    else:
                        placeholder = pygame.Surface(Morte.tamanho_sprite_definido, pygame.SRCALPHA); placeholder.fill((200, 0, 0)); Morte.sprites_originais.append(placeholder)
                except pygame.error:
                    placeholder = pygame.Surface(Morte.tamanho_sprite_definido, pygame.SRCALPHA); placeholder.fill((200, 0, 0)); Morte.sprites_originais.append(placeholder)
            
            if not Morte.sprites_originais:
                placeholder = pygame.Surface(Morte.tamanho_sprite_definido, pygame.SRCALPHA); placeholder.fill((150, 0, 0)); Morte.sprites_originais.append(placeholder)
    ...
    def __init__(self, x, y, velocidade=2.5):
        ...
        super().__init__(x, y,
                         ...
                         dano_contato=10,
                         xp_value=75, 
                         sprite_path="Sprites/Inimigos/Morte/A(1).png")
        self.moedas_drop = 12
        
        self.sprites = Morte.sprites_originais
        self.sprite_index = 0
