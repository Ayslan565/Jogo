...
try:
    ...
    # print(f"DEBUG(Cavaleiro): Classe InimigoBase importada com sucesso de .Inimigos.")
except ImportError as e:
    # print(f"DEBUG(Cavaleiro): FALHA ao importar InimigoBase de .Inimigos: {e}. Usando placeholder local MUITO BÁSICO.")
...
class Cavaleiro(InimigoBase):
    sprites_andar_carregados = None
    sprites_atacar_carregados = None
    tamanho_sprite_definido = (180, 280)
    som_ataque_Cavaleiro, som_dano_Cavaleiro, som_morte_Cavaleiro = None, None, None
    sons_carregados = False

    @staticmethod
    def _obter_pasta_raiz_jogo():
        diretorio_script_Cavaleiro = os.path.dirname(os.path.abspath(__file__))
        return os.path.abspath(os.path.join(diretorio_script_Cavaleiro, "..", ".."))

    @staticmethod
    def _carregar_lista_sprites_estatico(caminhos, lista_destino, tamanho, nome_anim):
        pasta_raiz = Cavaleiro._obter_pasta_raiz_jogo()
    ...
    @staticmethod
    def carregar_recursos_Cavaleiro():
        if Cavaleiro.sprites_andar_carregados is None:
            caminhos_andar = [
                "Sprites/Inimigos/Cavaleiro/A (1).png",
                "Sprites/Inimigos/Cavaleiro/A (2).png",
                "Sprites/Inimigos/Cavaleiro/A (3).png",
                "Sprites/Inimigos/Cavaleiro/A (4).png",
                "Sprites/Inimigos/Cavaleiro/A (5).png",
                "Sprites/Inimigos/Cavaleiro/A (6).png",
                "Sprites/Inimigos/Cavaleiro/A (7).png",
                "Sprites/Inimigos/Cavaleiro/A (8).png",
                "Sprites/Inimigos/Cavaleiro/A (9).png",
                "Sprites/Inimigos/Cavaleiro/A (10).png"
            ]
            Cavaleiro.tamanho_sprite_definido = (200, 200)
            
            Cavaleiro.sprites_andar_carregados = []
            Cavaleiro._carregar_lista_sprites_estatico(caminhos_andar, Cavaleiro.sprites_andar_carregados, Cavaleiro.tamanho_sprite_definido, "Andar")
            Cavaleiro.sprites_andar_carregados = Cavaleiro._carregar_lista_sprites_estatico(caminhos_andar, [], Cavaleiro.tamanho_sprite_definido, "Andar/Idle")
            if not Cavaleiro.sprites_atacar_carregados:
                Cavaleiro.sprites_atacar_carregados = [Cavaleiro.sprites_andar_carregados[0]]
        if not Cavaleiro.sons_carregados:
            # Carregar sons aqui
            Cavaleiro.sons_carregados = True
    ...
    def __init__(self, x, y, velocidade=1.3): 
        ...
        super().__init__(
            x, y,
            Cavaleiro.tamanho_sprite_definido[0], Cavaleiro.tamanho_sprite_definido[1],
            vida_Cavaleiro, velocidade, dano_contato_Cavaleiro,
            xp_Cavaleiro, sprite_path_principal_relativo_jogo
        )
        
        # Removido: Flag self.recursos_concedidos, pois a lógica de recompensa é externa

        self.sprites_andar = Cavaleiro.sprites_andar_carregados
        self.sprites_atacar = Cavaleiro.sprites_atacar_carregados
        self.sprites = self.sprites_andar
        
        if not (hasattr(self, 'image') and isinstance(self.image, pygame.Surface)):
            if self.sprites: self.image = self.sprites[0]
            else:
                self.image = pygame.Surface(Cavaleiro.tamanho_sprite_definido, pygame.SRCALPHA); self.image.fill((100, 50, 10, 150))
        ...
        self.attack_hitbox_size = (Cavaleiro.tamanho_sprite_definido[0] * 0.6, Cavaleiro.tamanho_sprite_definido[1] * 0.5)
        self.attack_hitbox_offset_x = Cavaleiro.tamanho_sprite_definido[0] * 0.4
